 ...
 function enterTodotext(enterdtext){
  ...
  return(
    <View style = {styles.flexForTodo}>
        <TextInput style={styles.textInput} onChangeText={enterTodotext} value={enteredtodoText} placeholder= 'Add your Text'></TextInput>
        <Button title="Submit" color={'blue'} onPress ={onPress} />
      </View>
  );
}
